...
public class HelloWorldController {
    ...
    public HelloWorldController(MyService myService, @Property(name = "hello.world.message") String helloFromConfig, HelloWorldTranslationConfig translationConfig) {
